...
/**
 * Parses SUMO network files (.net.xml) to extract road network topology and geometry.
 * 
 * <p>This class reads the XML network file generated by SUMO and creates data structures containing:
 * <ul>
 *   <li>Junctions (intersections) with positions and shapes</li>
 *   <li>Edges (road segments) with their lanes</li>
 *   <li>Lanes with speed limits, lengths, and widths</li>
 *   <li>Connections (junction links) with traffic light assignments</li>
 *   <li>Network bounding box (min/max X/Y coordinates)</li>
 * </ul>
 *
...
public class NetworkParser {
    /**
     * Data class representing a junction (intersection) in the road network.
     */
     ...
     * Connections define which lanes can transition from one edge to another,
     * and which traffic lights control those transitions.
     */
    public static class Connection {
         ...
         * @param tl Traffic light ID (null if none)
    ...
    public static class Edge {
        ...
        /**
         * Returns the total width of this edge by summing all lane widths.
         * 
    ...
    /**
     * Parses a SUMO network XML file and extracts all network topology data.
     * 
     * @param path Path to the .net.xml file
     * @return NetworkData containing all junctions, edges, connections, and bounds
     * @throws Exception if file not found or XML parsing fails
     */
