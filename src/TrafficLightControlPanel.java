...
public class TrafficLightControlPanel {
    ...
    public TrafficLightControlPanel(TrafficLight light, SimulationRunner runner, TrafficManager trafficManager, Runnable onBackPressed) {
    ...
    private void createUI() {
        ...
        forceGreenBtn.setOnMouseEntered(e -> {
            if (!isCurrentlyGreen()) forceGreenBtn.setStyle(greenHover);
        });
        ...
        forceRedBtn.setOnMouseEntered(e -> {
            if (!isCurrentlyRed()) forceRedBtn.setStyle(redHover);
        });
